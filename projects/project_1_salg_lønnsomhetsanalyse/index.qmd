...
subtitle: "KPI-design, marginanalyse og beslutningsstøtte i Power BI."
format:
  html:
    toc: true
    lightbox: true
...
-    Dimensjoner: Dato, Kategori, Segment, Region, State, City
...
-   AOV ned (-6 % på market-siden)

## Market & Drilldown

![](bilder/market dash.png)
...
## Shipping Mode & Regional Margin Analysis

![](bilder/levering og margin.png)
...
## Discount & Margin Breakdown

![](bilder/rabatt & volum.png)
