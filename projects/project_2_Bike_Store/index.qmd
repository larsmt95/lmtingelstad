...
subtitle: "Et komplett analyseprosjekt som viser hvordan salgsdata kan struktureres, modelleres og visualiseres for å forklare hva som driver omsetning og vekst på tvers av butikker, produkter og tid."
format:
  html:
    toc: true
    lightbox: true
...
![](bilder/dashboard.png)

Dashboardet viser at salgsveksten i Bike Store er sterk (+42,0 % YoY), men samtidig tydelig konsentrert.
